<div id='adminleft'>
	...
	<table>
		<form method='POST'>
			...
			<tr>
				<td><input class='input' type='text' name='stock' disabled='true' value='15' autofocus required/></td>
			</tr>
			<tr>
				<td>Added Stock</td>
			</tr>
			<tr>
				<td><input class='input' type='number' min='1' name='addedstock' placeholder='Added Stock Value' onfocus="if (this.placeholder == &#39;Added Stock Value&#39;) {this.placeholder = &#39;&#39;;}" onblur="if (this.placeholder == &#39;&#39;) {this.placeholder = &#39;Added Stock Value&#39;;}" autofocus required/></td>
			</tr>
			<tr>
				<td>Serials</td>
			</tr>
			<tr>
				<td><textarea class='textarea' name='description' placeholder='Serials. separated by comma' onfocus="if (this.placeholder == &#39;Serials. separated by comma&#39;) {this.placeholder = &#39;&#39;;}" onblur="if (this.placeholder == &#39;&#39;) {this.placeholder = &#39;Serials. separated by comma&#39;;}" autofocus required></textarea></td>
			</tr>
			<tr>
				<td colspan='2'>
