...
<div id='productright'>
	...
	<form method='POST' style='margin: 0 0 20px 0;'>
		<input style='width: 165px; border: none; float: right; margin: 5px 1px 5px 0px; border: 1px solid #fff; box-shadow: 0px 0px 1px #000;' type='submit' class='inputbutton' name='processpayment' value='PROCESS PAYMENT'/>
	</form>
