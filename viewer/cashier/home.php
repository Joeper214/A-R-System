<?php
	...
	$goTo = new GetModel();
	$accountID = $goTo -> get_account_id($_SESSION['cashierUsername'], $_SESSION['cashierPassword']);
...
<ul id='accountlink'>
	<li><a href="cashier.php?option=edituserinformation&personID=<?php echo $user['personID'];?>">Edit Information</a></li>
	<li><a href='cashier.php?option=changeusername&accountID=<?php echo $accountID; ?>'>Change Username</a></li>
	<li><a href='cashier.php?option=changepassword&accountID=<?php echo $accountID; ?>' >Change Password</a></li>
	<li><a href='cashier.php?option=changeaccountpicture&accountID=<?php echo $accountID;?>'>Change Account Picture</a></li>
</ul>
</br>
<div id="img">
...
<table id='emptable'>
	...
	<tr>
		<td>Religion</td>
		<td>:<input class='inputv' type='text' name='religion' disabled='true' value="<?php echo $user['religion']; ?>" /></td>
	</tr>
	<tr>
		<td>Position</td>
