<div id='adminleft'>
	...
	<form method='POST'>
		<table>
			...
			<tr>
				<td><input class='input' style='width: 255px;' type='text' name='fname' value='Zahra Fatma' autofocus required /></td>
			</tr>
			<tr>
				<td>Middle name</td>
			</tr>
			<tr>
				<td><input class='input' style='width: 255px;' type='text' name='mname' value='M.' autofocus required/></td>
			</tr>
			<tr>
				<td>Last name</td>
			</tr>
			<tr>
				<td><input class='input' style='width: 255px;' type='text' name='lname' value='Alsharief' autofocus required/></td>
			</tr>
			<tr>
				<td>Address</td>
			</tr>
			<tr>
				<td><input class='input' style='width: 255px;' type='text' name='address' value='fishville, MSU-Marawi City' autofocus required/></td>
			</tr>
			<tr>
				<td>Contact number</td>
			</tr>
			<tr>
				<td><input class='input' style='width: 255px;' type='text' name='contact' value='09359360836' autofocus required/></td>
			</tr>
			<tr>
...
<div id='adminright'>
	...
	<?php
		require_once('repairAppliedPopUp.php');
	?>
...
<?php
	if(isset($_POST['save'])) {
		echo "<script>repairSaved()</script>";
	} else if(isset($_POST['cancel'])) {
		echo "<script>repair()</script>";
	}
?>